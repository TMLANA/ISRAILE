...
download_file('https://raw.githubusercontent.com/TMLANA/ISRAILE/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/TMLANA/ISRAILE/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/TMLANA/ISRAILE/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/TMLANA/ISRAILE/master/inc/functions.lua','./inc/functions.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "اسرائيلي"
...
elseif UserID == 1360358971 or UserID == 1799179808 then 
return sendMsg(ChatID,MsgID,"⚜️*¦* لا يمكنك طرد مبرمج السورس\n🛠") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1360358971 or UserID == 1799179808 then 
return sendMsg(ChatID,MsgID,"⚜️*¦* لا يمكنك حظر مبرمج السورس\n🛠") 
elseif UserID == SUDO_ID then 
...
elseif UserID == 1360358971 or UserID == 1799179808 then 
return sendMsg(ChatID,MsgID,"⚜️*¦* لا يمكنك كتم مبرمج السورس\n🛠") 
elseif UserID == SUDO_ID then 
...
if UserID == 1360358971 or UserID == 1799179808 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مبرمج السورس \n❕") end
