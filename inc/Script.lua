...
local function iBoss(msg,MsgText)
    ...
    return '👨🏾‍🔧¦ اصدار سورس اسرائيلي : *v'..version..'* \n📡'
    end
    ...
    sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس اسرائيلي يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
    end  
    else
    ...
    local inline = {{{text="قنآهہ‏‏ آلسـورس : اسرائيلي 🍃",url="t.me/SourceIsrail"}}}
    send_key(msg.sender_user_id_,'  [قناة السورس : اسرائيـلي](t.me/SourceIsrail)',nil,inline,msg.id_)
    return false
    end
